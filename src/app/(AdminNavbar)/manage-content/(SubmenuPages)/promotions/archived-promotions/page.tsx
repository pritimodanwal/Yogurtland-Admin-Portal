...
interface ArchivedPromotion {
    name: string;
}

const ARCHIVED_PROMOTIONS: ArchivedPromotion[] = [
    { name: "Flavor Quest" },
]
            ...
            <Paper elevation={0} sx={{ border: "1px solid #e5e7eb", borderRadius: 2, overflow: "hidden" }}>
                <TableContainer>
                    <Table>
                        ...
                        <TableBody>
                            {ARCHIVED_PROMOTIONS.length === 0 ? (
                                <TableRow>
                                    <TableCell colSpan={2} align="center" sx={{ py: 8, color: "#9ca3af" }}>
                                        <Typography variant="body1">No archived promotions found.</Typography>
                                    </TableCell>
                                </TableRow>
                            ) : (
                                ARCHIVED_PROMOTIONS.map((promotion, index) => (
                                    <TableRow
                                    ...
                                    >
                                        <TableCell sx={{ color: "#1a1a1a" }}>{promotion.name}</TableCell>
