...
const ARCHIVED_CAREERS: ArchivedCareer[] = [
    { name: "2 Part-time Shift Leaders - Huntington Beach Edinger - Huntington Beach, CA" },
]
...
export default function ArchivedCareersPage() {
            ...
            <Paper elevation={0} sx={{ border: "1px solid #e5e7eb", borderRadius: 2, overflow: "hidden" }}>
                <TableContainer>
                    <Table>
                        ...
                        <TableBody>
                            {ARCHIVED_CAREERS.length === 0 ? (
                                <TableRow>
                                    <TableCell colSpan={2} align="center" sx={{ py: 8, color: "#9ca3af" }}>
                                        <Typography variant="body1">No archived careers found.</Typography>
                                    </TableCell>
                                </TableRow>
                            ) : (
                                ARCHIVED_CAREERS.map((career, index) => (
                                    <TableRow
                                    ...
                                    >
                                        <TableCell sx={{ color: "#1a1a1a" }}>{career.name}</TableCell>
