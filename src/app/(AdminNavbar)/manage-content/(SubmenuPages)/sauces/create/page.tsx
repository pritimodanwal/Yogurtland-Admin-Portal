        ...
        <Box sx={{ p: 4, maxWidth: "100%" }}>
            ...
            >
                ...
                <Button
                    ...
                    onClick={() => router.push("/manage-content/sauces")}
                    sx={{
                        borderColor: "#9C0752",
                        color: "#9C0752",
                        "&:hover": {
            ...
            <FieldRow label="Image">
                <Typography variant="caption" sx={{ display: "block", mb: 0.5, color: "#6b7280" }}>
                    NOTE: Image should be a minimum of 176x176 and be a square aspect ratio (both dimensions the same)
                </Typography>
