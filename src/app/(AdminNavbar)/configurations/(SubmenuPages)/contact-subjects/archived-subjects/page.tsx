...
const ARCHIVED_SUBJECTS: ArchivedSubject[] = [];
            ...
            <Paper elevation={0} sx={{ border: "1px solid #e5e7eb", borderRadius: 2, overflow: "hidden" }}>
                <TableContainer>
                    <Table>
                        ...
                        <TableBody>
                            {ARCHIVED_SUBJECTS.length === 0 ? (
                                <TableRow>
                                    <TableCell colSpan={2} sx={{ py: 2, color: "#333", fontSize: "15px" }}>
                                        There are currently no archived subjects.
                                    </TableCell>
                                </TableRow>
                            ) : (
                                ARCHIVED_SUBJECTS.map((subject, index) => (
                                    <TableRow
                                    ...
                                    >
                                        <TableCell sx={{ color: "#1a1a1a" }}>{subject.name}</TableCell>
